...
InitialEXRotation::InitialEXRotation(){
    frame_count = 0;
    Rc.push_back(Matrix3d::Identity());// 相机之间旋转矩阵，对极几何得到
    Rc_g.push_back(Matrix3d::Identity());// 每个IMU相对于起始IMU的旋转矩阵
    Rimu.push_back(Matrix3d::Identity());// 两个IMU之间旋转矩阵，由IMU预积分得到
    ric = Matrix3d::Identity();// 相机到IMU的外参
}
